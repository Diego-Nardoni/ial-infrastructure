...
install_deb() {
    ...
    DEB_URL="https://github.com/${GITHUB_REPO}/raw/main/dist/packages/ialctl_6.30.6_memory_perfect_amd64.deb"
...
install_rpm() {
    ...
    RPM_URL="https://github.com/${GITHUB_REPO}/raw/main/dist/packages/ialctl-6.30.6_memory-1.x86_64.rpm"
