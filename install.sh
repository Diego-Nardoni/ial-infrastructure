...
VERSION="6.30.7-memory-cross-session"
...
install_deb() {
    ...
    DEB_URL="https://github.com/${GITHUB_REPO}/raw/main/dist/packages/ialctl_6.30.7_memory_cross_session_amd64.deb"
...
install_rpm() {
    ...
    RPM_URL="https://github.com/${GITHUB_REPO}/raw/main/dist/packages/ialctl-6.30.7_memory_cross-1.x86_64.rpm"
