#!/bin/bash
# IAL Infrastructure CLI - Installation Script v6.29.6 Ultra Clean
# Supports: Ubuntu, Debian, Amazon Linux, CentOS, RHEL, Fedora

set -e

VERSION="6.29.6-ultra-clean"
...
install_deb() {
    ...
    DEB_URL="https://github.com/${GITHUB_REPO}/raw/main/dist/packages/ialctl_6.29.6_ultra_clean_amd64.deb"
...
install_rpm() {
    ...
    RPM_URL="https://github.com/${GITHUB_REPO}/raw/main/dist/packages/ialctl-6.29.6_ultra-1.x86_64.rpm"
...
if command -v ialctl >/dev/null 2>&1; then
    ...
    echo "  ialctl \"oi tudo bem?\"            # Ultra clean conversation"
    ...
    echo "✨ Now with ultra-clean output (55% less noise)!"
else
