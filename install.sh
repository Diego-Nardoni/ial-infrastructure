...
VERSION="6.30.8-memory-complete-final"
...
install_deb() {
    ...
    DEB_URL="https://github.com/${GITHUB_REPO}/raw/main/dist/packages/ialctl_6.30.8_memory_complete_final_amd64.deb"
...
install_rpm() {
    ...
    RPM_URL="https://github.com/${GITHUB_REPO}/raw/main/dist/packages/ialctl-6.30.8_memory_complete-1.x86_64.rpm"
